    ...
    <div className='container about-section' id='about'>
     <Row>
      ...
      <div className="profile-info mb-4">
        ...
        <p className='text-center mt-2'><b>Profile</b>: Persuing BSCS from Agriculture University,Become a Web Developer at SMIT</p>
        <p className='text-center'><b>Email</b>:<a href='hafizmuhammadusama664@gmail.com'> hafizmuhammadusama664@gmail.com</a></p>
        <p className='text-center'><b>Phone/Whatts App No</b>: +92 305-5565781</p>
      </div> 
      </Col>
