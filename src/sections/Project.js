...
import LoginPage from '../assets/image 4.png'
...
export default function Project() {
  const projects = [
    ...
    {
      title: "Login Page",
      description: 'Login and Signup page built with React, CSS and Bootstrap.',
      image: LoginPage,
      link: 'https://roaring-kleicha-eb6bfd.netlify.app/',
    }
  ]
  return (
