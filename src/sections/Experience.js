    ...
    <div className='expertise-container mt-4' id='expertise'>
      ...
      <Row justify="center" gutter={[16,16]} >
        ...
        <div className="expertise-card">
          ...
          <p>Building responsive and user-friendly websites using HTML, CSS, SASS, Bootstrap Javascript, React and Firebase.</p>
        </div>
        </Col>
        ...
        <div className="expertise-card">
          ...
          <h3>UX/UI Design</h3>
          <p>My goal is to become proficient in UX/UI design,that meet users' needs and exceed their expectations.</p>
        </div>
        </Col>
